...
public class Hashes {
    ...
    public String forcaBruta(String alg, String hash, String salt) {
        ...
        // Probar longitudes de 6 a 1 caracteres
...
private boolean tryCombinations(String alg, String hash, String salt, String charset, char[] password, int position, int length) {
    if (position == length) {
        npass++;
